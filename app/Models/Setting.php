...
class Setting extends Model
{
    ...
    private static array $settingMeta = [
        ...
        'bank_iban' => ['label' => 'IBAN rekeningnummer', 'group' => 'Afspraken - Betaling', 'description' => 'IBAN voor EPC QR-code betalingen (bijv. BE68 5390 0754 7034). Laat leeg om QR-code betaling uit te schakelen.'],
        'bank_account_name' => ['label' => 'Naam rekeninghouder', 'group' => 'Afspraken - Betaling', 'description' => 'Naam op de rekening (bijv. G-Win Comm.V). Wordt getoond in de QR-code.'],
        'bank_bic' => ['label' => 'BIC/SWIFT code', 'group' => 'Afspraken - Betaling', 'description' => 'BIC code van de bank (bijv. TRIOBEBBXXX). Optioneel maar aanbevolen voor snellere verwerking.'],
